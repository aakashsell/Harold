...
class BadgeViewModel: ObservableObject {
    ...
    func checkAndUpdateBadges(modelContext: ModelContext) async {
        ...
        do {
            ...
            // Your existing badge update logic here
            // Update badge progress, etc.
    ...
    func loadBadges(modelContext: ModelContext) async {
        ...
        func initializeBadgesIfNeeded() async {
            let descriptor = FetchDescriptor<Badge>()
        ...
        func calculateProgress(for badge: Badge) async throws -> Double {
            switch badge.name {
        ...
        func calculatePhotoProgress() async throws -> Double {
        ...
        func calculatePotSizeProgress() async throws -> Double {
        ...
        func calculateSeasonalProgress() async throws -> Double {
        ...
        func calculateWateringMethodsProgress() async throws -> Double {
            var descriptor = FetchDescriptor<CareEvent>()
            descriptor.predicate = #Predicate<CareEvent> { event in
                event.type == .water
            }
        ...
        func calculateSavingsProgress() async throws -> Double {
            var descriptor = FetchDescriptor<CareEvent>()
            descriptor.predicate = #Predicate<CareEvent> { event in
                event.type == .harvest
            }
        ...
        func calculateColorProgress() async throws -> Double {
            let descriptor = FetchDescriptor<Plant>()
            let plants = try modelContext.fetch(descriptor)
        ...
        func calculateFruitProgress() async throws -> Double {
            var descriptor = FetchDescriptor<CareEvent>()
            descriptor.predicate = #Predicate<CareEvent> { event in
                event.type == .harvest
            }
        ...
        func calculateVeggieProgress() async throws -> Double {
            var descriptor = FetchDescriptor<CareEvent>()
            descriptor.predicate = #Predicate<CareEvent> { event in
                event.type == .harvest
            }
        ...
        func calculateContinuousHarvestProgress() async throws -> Double {
            var descriptor = FetchDescriptor<CareEvent>()
            descriptor.predicate = #Predicate<CareEvent> { event in
                event.type == .harvest
            }
        ...
        func calculateGlobalPlantsProgress() async throws -> Double {
            let descriptor = FetchDescriptor<Plant>()
            let plants = try modelContext.fetch(descriptor)
        ...
        func calculatePlantHealerProgress() async throws -> Double {
        ...
        func calculateRecycledSuppliesProgress() async throws -> Double {
